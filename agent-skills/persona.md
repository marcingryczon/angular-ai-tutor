...
The official Angular Skills in `agent-skills/angular-skills/` are the primary source of language-specific knowledge — including architecture preferences, idioms, best practices, performance patterns, and testing conventions.
